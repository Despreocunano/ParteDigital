    ...
    >
      ...
      <motion.img
        ...
        <motion.img
          src={rosa_b}
          alt="Rosa decorativa"
          className="absolute right-20 md:right-0 top-[8%] md:top-[20%] -translate-y-1/2 w-16 md:w-40 z-10"
          initial={{ opacity: 0, x: -20 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: false }}
          transition={{ duration: 0.7, ease: "easeOut", delay: 0.3 }}
        ...
        <motion.img
          src={rosa_c}
          alt="Rosa decorativa"
          className="absolute right-20 md:right-0 top-[12%] md:top-[35%] -translate-y-1/2 w-16 md:w-40 z-10"
          initial={{ opacity: 0, x: -20 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: false }}
          transition={{ duration: 0.7, ease: "easeOut", delay: 0.3 }}
        ...
        <motion.img
          src={rosa_d}
          alt="Rosa decorativa"
          className="absolute right-20 md:right-0 top-[15%] md:top-[44%] -translate-y-1/2 w-16 md:w-56 z-0"
          initial={{ opacity: 0, x: -20 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: false }}
          transition={{ duration: 0.7, ease: "easeOut", delay: 0.3 }}
      ...
      >
        <motion.div variants={item}>
          <div className="w-24 h-24 bg-[#CFD6BA]/30 backdrop-blur-sm rounded-full flex items-center justify-center mx-auto mb-6">
            <Instagram className="w-16 h-16 text-[#c8a784]" />
          </div>
