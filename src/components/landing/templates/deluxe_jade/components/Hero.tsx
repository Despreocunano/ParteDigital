  ...
  return (
    ...
    <div className="grid grid-rows-[auto_auto] lg:grid-cols-2 h-full">
      ...
      <div className="relative flex items-center justify-center p-4 lg:p-6 z-10 lg:bg-transparent order-2">
        <div className="relative text-center text-[#C58F4D] w-full max-w-2xl mx-auto">
          ...
          <div className="py-20 px-2">
            ...
            <div className="space-y-4 mb-8">
              ...
              <p className="text-3xl md:text-4xl font-light tracking-widest uppercase text-white">
                {groomName} & {brideName}
              </p>
            </div>
            {welcomeMessage && (
              <>
                <p className="text-xl font-light leading-relaxed mb-6 text-white">
                  {welcomeMessage}
                </p>
