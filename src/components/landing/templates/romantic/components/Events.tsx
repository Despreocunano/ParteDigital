...
function Event({ title, date, time, location, details, className = '' }: EventProps) {
  return (
    <div className={`bg-[#1C2127] rounded-2xl shadow-lg overflow-hidden border border-[#D4B572]/20 ${className}`}>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4">
              ...
              {details && (
                <p className="mt-2 text-[#D4B572]/80 leading-relaxed">{details}</p>
              )}
            </div>
          </div>
        </div>
      ...
      <section className={`py-32 px-4 ${className}`}>
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-serif text-[#D4B572]">Eventos</h2>
