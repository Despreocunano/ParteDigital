    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#1C2127]">
      <div className="relative w-full max-w-2xl px-8 py-12 text-center text-[#D4B572]">
        ...
        <div className="space-y-8">
          ...
          <div className="w-px h-12 bg-[#D4B572]/30 mx-auto"></div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                className="bg-[#D4B572] hover:bg-[#C4A562] text-[#1C2127] px-8 py-3 rounded-none"
              >
              ...
              <Button
                ...
                className="border-[#D4B572] text-[#D4B572] hover:bg-[#D4B572]/10 px-8 py-3 rounded-none"
              >
                Ingresar sin música
              </Button>
            </div>
